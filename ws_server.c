...
static const struct lws_http_mount mount = {
        NULL, "/", "/opt/pulsar/www/html", "desktop.html",
        NULL, NULL, NULL, NULL,
        0, 0, 0, 0, 0, 0, LWSMPRO_FILE, 1, NULL
};

static struct lws_protocols protocols[] = {
        {"cloudware-interacting-protocol", callback_protocol,       sizeof(pulsar_context_t), 8000000},
...
void start_ws_server(pulsar_config_t *pulsar_config) {
  ...
  if (display == NULL) {
    printf("Error: display == NULL, system exist!\n");
    return;
  }
